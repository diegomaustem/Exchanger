...
<head>
  ...
  <link href="assets/demo/outside.css" rel="stylesheet" />
</head>
  ...
  <div class="wrapper ">
    <div class="sidebar" data-color="white" data-active-color="danger">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li>
            <a href="./examples/listarmodels.php">
              <i class="nc-icon nc-paper"></i>
              <p>Listar Models</p>
            </a>
          </li>
          <li>
            <a href="./examples/cadastrarmodels.php">
              <i class="nc-icon nc-single-copy-04"></i>
              <p>Cadastrar Models</p>
            </a>
          </li>
          <li>
            <a href="./examples/gerarlink.php">
              <i class="nc-icon nc-globe"></i>
              <p>Gerar Links</p>
            </a>
          </li>
          <li>
            <a href="./examples/listarLinks.php">
              ...
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                   <a href="./examples/listarmodels.php"> 
                      <div class="numbers">
                        <p class="card-category">LISTAR</p>
                        <p class="card-title">MODELS<p>
                      </div> 
                  </a>
                  </div>
                </div>
